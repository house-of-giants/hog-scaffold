...
$portfolio
  ...
  ->add_meta_field('project_url', array(
    'type' => 'string',
  ...
  ->add_meta_field('project_status', array(
    'type' => 'string',
  ...
  ->add_meta_field('featured_project', array(
    'type' => 'boolean',
...
$portfolio
  ->add_taxonomy('portfolio_category', 'Portfolio Category', 'Portfolio Categories', 'portfolio-category', array(
    'hierarchical' => true,
    'description' => __('Categorize portfolio items by type or industry', 'hog-scaffold'),
  ))
  ->add_taxonomy('portfolio_tag', 'Portfolio Tag', 'Portfolio Tags', 'portfolio-tag', array(
    'hierarchical' => false,
    'description' => __('Tag portfolio items with relevant keywords', 'hog-scaffold'),
  ))
  ->add_taxonomy('portfolio_skill', 'Skill', 'Skills', 'skill', array(
    'hierarchical' => false,
...
add_action('rest_api_init', function () {
  ...
  register_rest_route('hog-scaffold/v1', '/portfolio/featured', array(
    'methods' => 'GET',
  ...
  register_rest_route('hog-scaffold/v1', '/portfolio/category/(?P<slug>[a-zA-Z0-9_-]+)', array(
    'methods' => 'GET',
