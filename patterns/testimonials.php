 ...
 * Description: Testimonials section with testimonials and their descriptions.
 * Keywords: testimonials, descriptions, features
 */
?>

<!-- wp:group {"metadata":{"categories":["hog-scaffold-sections","text","featured"],"patternName":"hog-scaffold/testimonials","name":"Testimonials Section"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"base-2","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group has-base-background-color has-background"
        ...
        <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
          ...
          <figure class="wp-block-image size-thumbnail is-resized has-custom-border"><img
              src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&amp;auto=format&amp;fit=crop&amp;w=150&amp;q=80"
              alt="Sarah Johnson" style="border-radius:50px;width:60px;height:60px" /></figure>
          <!-- /wp:image -->
      ...
      <div class="wp-block-group has-base-background-color has-background"
        ...
        <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
          ...
          <figure class="wp-block-image size-thumbnail is-resized has-custom-border"><img
              ...
              alt="Michael Chen" style="border-radius:50px;width:60px;height:60px" /></figure>
          <!-- /wp:image -->
      ...
      <div class="wp-block-group has-base-background-color has-background"
        ...
        <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
          ...
          <figure class="wp-block-image size-thumbnail is-resized has-custom-border"><img
              ...
              alt="Emily Rodriguez" style="border-radius:50px;width:60px;height:60px" /></figure>
          <!-- /wp:image -->
