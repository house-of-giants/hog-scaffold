...
<div class="wp-block-group alignwide"
  ...
  <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center"} -->
    <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
      ...
      <!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"fontSize":"large"} -->
      <p class="has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--50)">
        We're passionate about creating digital experiences that make a difference. Our team combines creativity with
      ...
      <ul style="margin-bottom:var(--wp--preset--spacing--50)" class="wp-block-list"><!-- wp:list-item -->
    ...
    <div class="wp-block-column is-vertically-aligned-center">
      ...
      <figure class="wp-block-image size-large has-custom-border"><img
          ...
          alt="Team collaboration" style="border-radius:12px" /></figure>
      <!-- /wp:image -->
    </div>
    <!-- /wp:column -->
  </div>
